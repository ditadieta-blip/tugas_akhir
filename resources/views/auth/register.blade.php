...
<div class="flex flex-col md:flex-row bg-white shadow-xl rounded-[24px] overflow-hidden max-w-5xl w-full border border-gray-100">
    ...
    <div class="w-full md:w-1/2 bg-gray-50/50 flex flex-col items-center justify-center p-10 border-b md:border-b-0 md:border-r border-gray-100">
        <div class="mb-6">
            <img src="{{ asset('images/logo_senam.png') }}"
                 alt="Logo Senam"
                 class="w-32 h-32 md:w-44 md:h-44 object-contain">
        </div>
        <h1 class="text-sm md:text-base font-semibold text-gray-500 tracking-[0.2em] uppercase text-center leading-relaxed">
    ...
    <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white">
        ...
        <div class="mb-8 text-center">
            <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Registrasi</h2>
        </div>

        {{-- SUCCESS --}}
        @if(session('success'))
            <div class="mb-4 bg-green-50 border border-green-200 text-green-600 text-sm px-4 py-3 rounded-lg">
                {{ session('success') }}
            </div>
        @endif
